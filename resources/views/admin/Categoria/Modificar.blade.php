        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nomb_cat" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Nombre"  v-model="fillCategoria.nomb_cat">
                </div>
                 <div class="form-group">
                  <label>Observacion</label>
                  <textarea class="form-control" rows="3"  name="observ_cat" placeholder="Ingrese Observación"  v-model="fillCategoria.observ_cat"></textarea>
                </div>
                 <div class="form-group">
                  <label>Estado</label>
                ...
                <div class="input-group date">
                  ...
                  <input type="date" class="form-control" name="fechaini_cat" v-model="fillCategoria.fechaini_cat" >
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="date" class="form-control" name="fechafin_cat" v-model="fillCategoria.fechafin_cat">
                </div>
                <!-- /.input group -->
              </div>
                <div class="form-group">
