...
@section('content')
 <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{asset('updateCategoria/'.$categoria->id_cat)}}">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre</label>
                  <input type="text" name="nomb_cat" value="{{$categoria->nomb_cat}}" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Nombre">
                </div>
                 <div class="form-group">
                  <label>Observacion</label>
                  <textarea class="form-control" rows="3"  name="observ_cat" placeholder="Ingrese Observación">{{$categoria->observ_cat}}</textarea>
                </div>
                 <div class="form-group">
                  <label>Estado</label>
