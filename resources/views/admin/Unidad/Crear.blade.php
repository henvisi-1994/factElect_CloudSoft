            ...
            <form role="form"method="POST" action="/storeUnidad">
              <div class="box-body">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" placeholder="aaaa-mm-yyyy" name="fechaini_unidad">
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker"  placeholder="aaaa-mm-yyyy" name="fechafin_unidad">
                </div>
                <!-- /.input group -->
              </div>
