              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset("Administrador/dist/img/user3-128x128.jpg") }}"class="img-circle" alt="User Image">
                      </div>
                      <h4>
...
<!-- Sparkline -->
<script src="{{ asset("Administrador/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js") }}"></script>
<!-- jvectormap -->
<script src="{{ asset("Administrador/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js") }}"></script>
<script src="{{ asset("Administrador/plugins/jvectormap/jquery-jvectormap-world-mill-en.js") }}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset("Administrador/bower_components/jquery-knob/dist/jquery.knob.min.js") }}"></script>
<!-- daterangepicker -->
<script src="{{ asset("Administrador/bower_components/moment/min/moment.min.js") }}"></script>
<script src="{{ asset("Administrador/bower_components/bootstrap-daterangepicker/daterangepicker.js") }}"></script>
<!-- datepicker -->
