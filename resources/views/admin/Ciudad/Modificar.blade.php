            ...
            <form role="form" method="POST" action="{{asset('updateCiudad/'.$ciudad->id_ciu)}}">
              <div class="box-body">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" name="fechaini_ciu" value="{{$ciudad->fechaini_ciu}}" id="datepicker" placeholder="aaaa-mm-yyyy">
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="fechafin_ciu" value="{{$ciudad->fechafin_ciu}}" placeholder="aaaa-mm-yyyy">
                </div>
                <!-- /.input group -->
              </div>
                <div class="form-group">
