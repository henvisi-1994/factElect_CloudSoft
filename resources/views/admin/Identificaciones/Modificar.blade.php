            ...
            <form role="form" method="POST" action="{{asset('updateIdentificaciones/'.$identificacion->id_ident)}}">
              <div class="box-body">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control" name="fechaini_ident" value="{{$identificacion->fechaini_ident}}" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control" name="fechafin_ident" value="{{$identificacion->fechafin_ident}}" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
