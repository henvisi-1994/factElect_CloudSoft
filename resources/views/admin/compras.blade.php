...
<div class="panel with-nav-tabs panel-primary">
   <div class="panel-heading">
        <ul class="nav nav-tabs">
			...
			<li><a  data-toggle="tab" href="#nav-factura" role="tab" aria-controls="nav-contact" aria-selected="false"><i class="fa fa-file-o"></i> Facturas</a></li>
			<li><a  data-toggle="tab" href="#nav-guiaRem"><i class="fa  fa-truck"></i> Guias de Remision</a></li>
