...
const app = new Vue({
    ...
    methods: {
        ...
        createCliente: function() {
            ...
            axios.post(urlGuardarCliente, this.newCliente).then((response) => {
                this.getCliente();
                this.cod_cli = '';
                this.observ_cli = '';
                this.estado_cli = '';
        ...
        updateCliente: function(id) {
            ...
            axios.post(url, this.fillCliente).then(response => {
                this.getCliente();
                //persona
        ...
        createFormulario: function() {
            ...
            axios.post(urlGuardarFormulario, this.newFormulario).then((response) => {
                this.getFormulario();
        ...
        updateFormulario: function(id) {
            ...
            axios.post(url, this.fillFormulario).then(response => {
                this.getFormulario();
        ...
        createFormaPago: function() {
            ...
            axios.post(urlGuardarFormaPago, this.newFormaPago).then((response) => {
                this.getFormaPago();
        ...
        updateFormaPago: function(id) {
            ...
            axios.post(url, this.fillFormaPago).then(response => {
                this.getFormaPago();
        ...
        createParam_Docs: function() {
            ...
            axios.post(urlGuardarParam_Docs, this.newParam_Docs).then((response) => {
                this.getParam_Docs();
        ...
        updateParam_Docs: function(id) {
            ...
            axios.post(url, this.fillParam_Docs).then(response => {
                this.getParam_Docs();
                this.nomb_param_docs = '';
                this.observ_param_docs = '';
                this.estado_param_docs = '';
        ...
        createParam_Porc: function() {
            ...
            axios.post(urlGuardarParam_Porc, this.newParam_Porc).then((response) => {
                this.getParam_Porc();
        ...
        updateParam_Porc: function(id) {
            ...
            axios.post(url, this.fillParam_Porc).then(response => {
                this.getParam_Porc();
                this.nomb_param_porc = '';
                this.observ_param_porc = '';
                this.estado_param_porc = '';
        ...
        createFacturaVenta: function() {
            ...
            axios.post(urlFactV, this.factura).then((response) => {
        ...
        guardaritem: function(id_fact) {
            ...
            this.detallefactura.reduce((total, item) => {
                axios.post(urlFacturaDetalle,item).then((response) => {}).catch(error => {
                    this.errors = error.response.data;
                });
            }, 0);
        }
