...
Route::post('storeProducto','ProductoController@guardarProducto');
...
Route::post('storeEmpresa','EmpresaController@guardarEmpresa');
...
Route::post('storeFacturaDetalle/{num_fact}','FacturaController@gurdarDetalleFacturaVenta');
//Ruta Modificar
...
Route::post('updateUsuario/{id}','UserController@modificarUsuario');
//Ruta Eliminar
