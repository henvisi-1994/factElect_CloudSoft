...
-- Volcando datos para la tabla facturacion.factura: ~2 rows (aproximadamente)
...
REPLACE INTO `factura` (`id_fact`, `id_formapago`, `id_per`, `num_fact`, `fecha_emision_fact`, `hora_emision_fact`, `vencimiento_fact`, `estado_fact`, `tipo_fact`, `observ_fact`, `subtotal_fact`, `subcero_fact`, `subiva_fact`, `subice_fact`, `total_fact`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, '001-001-0000000020', '2017-04-22', '15:18:05', '2019-04-17', 'PA', 'Compra', '-', NULL, NULL, NULL, NULL, 200, '2019-04-23 15:18:29', '2019-04-23 15:18:31'),
	(2, 1, 3, '001-001-0000000001', '2018-03-23', '14:00:00', '2018-02-14', 'PA', 'Venta', '-', NULL, NULL, NULL, NULL, 120, '2019-04-23 15:23:58', '2019-04-23 15:23:58');
